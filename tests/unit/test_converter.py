...
class TestNormalize:
    def test_return_empty_string_when_none(self):
    ...
    def test_return_str_representation_when_no_text(self):
        obj = type("NoText", (), {})()
...
class TestBuildReactions:
    def test_return_empty_list_when_reactions_is_none(self):
        msg = _make_msg(reactions=None)
        assert _build_reactions(msg) == []

    def test_return_empty_list_when_no_results_attr(self):
        reactions = type("NoResults", (), {})()
        assert _build_reactions(type("M", (), {"reactions": reactions})()) == []

    def test_return_empty_list_when_results_empty(self):
        reactions = type("RE", (), {"results": []})()
        assert _build_reactions(type("M", (), {"reactions": reactions})()) == []

    def test_build_reactions_with_emoticon(self):
    ...
    def test_fallback_to_str_when_no_emoticon(self):
...
class TestBuildPoll:
    def test_return_none_when_no_poll(self):
        assert _build_poll(_make_msg(poll=None)) is None

    def test_return_none_when_poll_without_inner(self):
        media = type("MP", (), {"poll": None})()
        assert _build_poll(_make_msg(poll=media)) is None

    def test_build_simple_poll(self):
    ...
    def test_build_poll_with_results(self):
...
class TestExtractLinks:
    def test_return_empty_list_when_no_entities(self):
        assert _extract_links(_make_msg(entities=None)) == []

    def test_extract_message_entity_text_url(self):
        raw = "click here"
    ...
    def test_set_text_none_when_label_equals_url(self):
    ...
    def test_extract_message_entity_url(self):
...
class TestDetectMediaType:
    def test_return_none_when_no_media(self):
    ...
    def test_detect_video_note(self):
    ...
    def test_detect_sticker(self):
        assert _detect_media_type(_make_msg(sticker=True)) == MediaType.STICKER

    def test_prioritize_sticker_over_photo(self):
...
class TestMessageToExport:
    ...
    def test_set_type_to_service_when_action_present(self):
    ...
    def test_return_correct_structure_for_empty_message(self):
    ...
    def test_extract_links_in_export(self):
        raw = "click here"
        ent = type("MessageEntityTextUrl", (), {
            "offset": 0,
            "length": 5,
