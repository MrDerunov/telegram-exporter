...
class TestMarkdownExporter:
    ...
    def should_return_no_files_when_empty(self):
        """Пустой список сообщений — нет файлов."""
        files = self._run([])
        assert files == []

    def should_create_file_with_author_and_text_for_single_message(self):
    ...
    def should_include_timestamp(self):
    ...
    def should_strip_markdown_in_plain_text_mode(self):
    ...
    def should_create_multiple_files_when_exceeding_word_limit(self):
    ...
    def should_create_popular_file_when_reactions_exceed_threshold(self):
    ...
    def should_not_create_popular_file_when_below_threshold(self):
    ...
    def should_not_crash_on_finalize_with_only_service_messages(self):
...
class TestFormatMessage:
    ...
    def should_format_timestamp(self):
    ...
    def should_format_reactions(self):
    ...
    def should_format_forwarded_from(self):
    ...
    def should_format_transcription(self):
        s = MarkdownSettings(include_timestamps=False, include_author=False)
