...
class TestExportHistoryLoad:
    ...
    def test_return_data_when_file_exists(self, tmp_path: Path):
...
class TestExportHistoryMarkers:
    def test_create_file_with_correct_data_when_mark_completed(self, tmp_path: Path):
    ...
    def test_create_file_with_interrupted_status(self, tmp_path: Path):
    ...
    def test_create_file_with_unavailable_status(self, tmp_path: Path):
    ...
    def test_overwrite_previous_data_on_save(self, tmp_path: Path):
    ...
    def test_not_leave_tmp_file_after_save(self, tmp_path: Path):
...
class TestExportHistoryExportHistoryClass:
    def test_be_instantiable_without_args(self):
        """ExportHistory можно создать без аргументов."""
        h = ExportHistory()
        assert h is not None

    def test_return_none_when_directory_does_not_exist(self, tmp_path: Path):
