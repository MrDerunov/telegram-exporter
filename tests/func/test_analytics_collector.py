...
class TestAnalyticsCollector:
    ...
    def test_return_empty_result_when_no_messages(self):
        """Пустой коллектор возвращает пустой результат."""
        result = self._collect([])
        assert result.authors == []
        assert result.activity == {}

    def test_count_messages_for_single_author(self):
    ...
    def test_sort_authors_by_message_count(self):
    ...
    def test_capture_username(self):
    ...
    def test_store_messages_for_author(self):
